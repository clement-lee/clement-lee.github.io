...
* Today's slides: https://clement-lee.github.io/slides/ukrn-20251022
...
2. install packages *inside* the `{renv}` environment

   * Ensures the packages & their versions go into your project's local library

3. write & knit R Markdown as usual
...
4. snapshot your environment when done
...
5. reproduce elsewhere and/or in the future
...
* Full reproducibility with package versions
  ...
  - R package [{renv}](https://cran.r-project.org/package=renv)
